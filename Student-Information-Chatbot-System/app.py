...
import sqlite3
import aiml
from updatemodel import sntnce as s
import random
import re
...
GREETING = ['Hello! My name is Bot. I will try my best to provide you information related to our College!']
...
def login(user=False):
    ...
    conn = sqlite3.connect('updatemodel\\newdbmodel\\db\\sqlite\\db\\pythonsqlite.db')
    c = conn.cursor()
