...
class Kernel:
    ...
    def __init__(self):
        ...
        self._botPredicates = {}
        self.setBotPredicate("name", "BOT")
        # setting botmaster
        self.setBotPredicate("botmaster","botmaster")
        # setting other bot attributes
        self.setBotPredicate("family","Student Enquiry Chat-bot based on AI")
        self.setBotPredicate("species","Chat-bot")
        self.setBotPredicate("order","robot")
        self.setBotPredicate("age","4 years")
        self.setBotPredicate("class","Chat-bot")
        self.setBotPredicate("master","Jesus")
        self.setBotPredicate("birthplace","Earth")
        self.setBotPredicate("location","Earth")
        ...
        self.setBotPredicate("nationality","Human")
        self.setBotPredicate("maxclients","100")
        self.setBotPredicate("state","Planet Earth")
        self.setBotPredicate("country","Universe")
